...
# declared a dictionary named unique_results
# for example :
# # unique_results = {
#     "red": "red,(15,42,50)",
            ...
            for result1, result2 in zip(results1, results2):
                ...
                for box1, confidence1, class_id1 in zip(boxes1, confidences1, class_ids1):
                    for box2, confidence2, class_id2 in zip(boxes2, confidences2, class_ids2):
                        ...
                        #change class_id1 to real class name like "ractangle1"
                        ...
                        #create a string like "red,(10,20,50)" and store in the unique_results dictionary under the key "red"
