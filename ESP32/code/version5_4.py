...
from position_ato1_ import *
from position_ato2_ import *
from position_ato3_ import *
from position_ato4_ import *
from position_ato5_ import *
from position_ato6_ import *
from position_atob_ import *
from position_bto1_ import *
from position_bto2_ import *
from position_bto3_ import *
from position_bto4_ import *
from position_bto6_ import *
from position_btoa_ import *
...
if __name__ == '__main__':
    ...
    while True:
        object_input = input("object_label (space) x_coor (space) y_coor: ")#請根據最上方提供的邊界值輸入x座標
        destination_input = input("destination_label (space) x_coor (space) y_coor: ")#請根據最上方提供的邊界值輸入y座標
