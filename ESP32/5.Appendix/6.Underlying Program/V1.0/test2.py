...
if __name__ == '__main__':
  ...
  while True:
        ...
        if place == 11:
            b.run_multiple_groups(action_groups_1to1)
            print("move from position 1->1")
        elif place == 12:
            b.run_multiple_groups(action_groups_1to2)
            print("move from position 1->2")
        elif place == 21:
            b.run_multiple_groups(action_groups_2to1)
            print("move from position 2->1")
        elif place == 22:
            b.run_multiple_groups(action_groups_2to2)
            print("move from position 2->2")
        else:
            b.run_multiple_groups(action_groups_default)
