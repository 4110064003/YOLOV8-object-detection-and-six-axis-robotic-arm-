...
class ArmController:
    ...
    def ArmControl_grab(self, object_coordinates, _time):
        ...
        self.bus_servo.run(1, 200, 1000)  # 設置夾爪打開，執行時間1000毫秒
    ...
    def execute_arm_sequence(self, object_coordinates, destination_coordinates):
        #執行整個抓取和釋放的動作序列。
        ...
        if success_grab:
            time.sleep_ms(2500)
            time.sleep_ms(100)
            print("Move object to destination...")
